...
# Click the quantity to make it == 2
...
while True:
    ...
    if btn_add_to_cart.get_attribute('disabled') is None:
        ...
        qty_value = qty_attr.get_attribute("value")
        ...
        selectable_country_dropdown.select_by_value(country)
        ...
        input_firstname_wait.send_keys(firstname)


        # STEP 05 --> input last name
        input_firstname = driver.find_element(By.NAME, "lastName")
        input_firstname_wait = WebDriverWait(driver, 10, poll_frequency=0.5).until(EC.element_to_be_clickable(input_firstname))
        input_firstname_wait.send_keys(lastname)
        ...
        input_address_wait.send_keys(address)
        ...
        input_address_02_wait.send_keys(address_02)
        ...
        input_city_wait.send_keys(city)
        ...
        selectable_state_dropdown.select_by_value(state)
        ...
        input_zip_wait.send_keys(zip_code)
        ...
        input_phone_wait.send_keys(phone)
        ...
        card_number_container.send_keys(cardnumber)
        ...
        expiration_date_container.send_keys(expiration_month)
        expiration_date_container.send_keys(expiration_year)
        driver.switch_to.default_content()
        ...
        security_code_container.send_keys(security_code)
        driver.switch_to.default_content()
        ...
        # ensure the shipping is the same as billing
        ...
        # ensure that our information is not saved by SHOP
